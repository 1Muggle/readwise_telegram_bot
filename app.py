...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await context.bot.send_message(
        ...
        text="Bot for integration with ReadWise api and Telegram. Forward me posts and I will send them to your \
            ReadWise. For more go to https://github.com/ixnet/telewise_bot",
    )
